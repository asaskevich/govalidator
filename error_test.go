...
func TestErrors_FirstError(t *testing.T) {
	...
	tests := []struct {
		...
		{Errors{}, ""},
		{Errors{fmt.Errorf("Error 1")}, "Error 1"},
		{Errors{fmt.Errorf("Error 1"), fmt.Errorf("Error 2")}, "Error 1"},
		{Errors{customErr, fmt.Errorf("Error 2")}, "Custom Error Name: stdlib error"},
		{Errors{fmt.Errorf("Error 123"), customErrWithCustomErrorMessage}, "Error 123"},
	}
