...
func ExampleInRangeInt() {
	_ = InRangeInt(context.Background(), 10, -10, 10) // true
	_ = InRangeInt(context.Background(), 10, 10, 20)  // true
	_ = InRangeInt(context.Background(), 10, 11, 20)  // false
}
...
func ExampleInRange() {
	_ = InRange(context.Background(), 10, 11, 20)             // false
	_ = InRange(context.Background(), 10.02, -10.124, 10.234) // true
	_ = InRange(context.Background(), "abc", "a", "cba")      // true
}
